requirejs.config({
	...
	paths:{
		...
		"tweenMax": "../libs/gsap/TweenMax-1.9.8",
		"timelineMax": "../libs/gsap/TimelineMax-1.9.8",
		//HandleBars
	...
	shim:{
		...
		*/
		'backbone': {
			deps: ['jquery','timelineMax','md5'], //necessary to add the dependency here as it makes sure $ is available to BackboneJS
			exports: 'Backbone',
			init: function(){
		...
		'timelineMax':{
			...
			exports:'TimelineMax',
			init: function(){
				console.log('TimelineMax : loaded : ');
			}
		},
		'md5':{
			exports: 'md5',
...
define(['underscore','jquery','localNotification','pushNotification','backbone','handlebars'],
	function(localUnderscore,localJQuery,localNotification,localPushNotification,localBackbone,localHandlebars){
